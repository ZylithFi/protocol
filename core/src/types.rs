...
pub fn price_base_scale_for_pair(pair_id: &PairId) -> u128 {
    ...
    match pair_id.0.as_str() {
        // STRK/strkBTC is below one raw quote unit per human STRK at market
        // prices, so it needs extra fixed-point precision for book checks.
        "STRK/strkBTC" => base_scale
            .checked_mul(1_000_000)
            .expect("price scale must fit in u128"),
        _ => base_scale,
    }
}
...
mod tests {
    ...
    #[test]
    fn ratio_pair_uses_extra_price_precision() {
